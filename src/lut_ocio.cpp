// OpenColorIO-backed LUT helpers (create_lut / apply_lut). Kept in a separate
// translation unit from write_cube so that consumers needing only the .cube
// serializer (the Premiere effect / CLIs) don't drag OpenColorIO — and its
// transitive deps — into their binary. write_cube lives in apply.cpp.
